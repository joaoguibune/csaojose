...
function csaojose_scripts() {
  ...
  wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/assets/css/animate.css' );
 ...
 * BAIXAR O LUGIN ADVANCED CUSTOM FIELDS
 **************************************/
...
/**************************************
* BAIXAR O PLUGIN ADVANCED CUSTOM FIELDS
 ...
 **************************************/
  if(function_exists("register_field_group"))
 {
 	register_field_group(array (
      ...
      array (
 				'key' => 'field_59532490de092',
 				'label' => 'Cor da Caixa de Texto',
 				'name' => 'cor_caixa_texto',
 				'type' => 'color_picker',
 				'default_value' => '#ffffff',
 			),
 			array (
 				'key' => 'field_595324aede091',
 				'label' => 'Cor do Texto',
 				'name' => 'cor_do_texto',
 				'type' => 'color_picker',
 	...
 	register_field_group(array (
 		...
 		'fields' => array (
 			array (
 				'key' => 'field_59530489e59d0',
 				'label' => 'Ícone',
 				'name' => 'icone',
 				'type' => 'font-awesome',
 				'instructions' => 'Selecione o ícone que irá aparecer para o campo destaque a ser criado(vazio para nenhum).',
 	...
 	register_field_group(array (
 		'id' => 'acf_texto-do-slider',
 		'title' => 'Texto do Slider',
 		'fields' => array (
 			array (
 				'key' => 'field_5953278ff4362',
 				'label' => 'Texto',
 				'name' => 'texto',
 				'type' => 'textarea',
 				'default_value' => '',
 			...
 			array (
 				'key' => 'field_59532769f4361',
 				'label' => 'Cor do Texto',
 				'name' => 'cor_do_texto',
 				'type' => 'color_picker',
 				'required' => 1,
 				'default_value' => '#982e42',
 			),
 		),
 		'location' => array (
 			array (
